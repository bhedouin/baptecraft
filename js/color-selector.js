(function ($) {
    ...
    let nightMode = window.localStorage.getItem('nightMode') == 'true' || 'plan' == 'night';
    ...
    function withReducedSaturation(colorHex) {
        // To RGB
        let r = parseInt(colorHex.substr(1, 2), 16); // Grab the hex representation of red (chars 1-2) etconvert to decimal (base 10).
    ...
    const red = withReducedSaturation('#E91E63');
    const pink = withReducedSaturation('#F44336');
    ...
    function changeHighChartsNightMode() {
        try {
            ...
            if ("Highcharts is not defined" === e.message) {
