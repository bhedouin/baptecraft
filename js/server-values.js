...
/* This function loads Serveur Overview tab */
...
function loadWorldPie(json, error) {
    if (json) {
        const worldSeries = {name: 'Temps de Jeu par Monde', colorByPoint: true, data: json.world_series};
...
function loadServeurCalendar(json, error) {
    if (json) {
...
function loadPunchCard(json, error) {
    if (json) {
        const punchCardSeries = {
            name: 'Activité de Connexion relative',
            color: json.color,
            data: json.punchCard
        };
